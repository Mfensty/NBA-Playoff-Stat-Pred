...
library(ggplot2)
ggplot(DW, aes(x = DW$`Total Game`, y = Reb)) + #Use the indicator markers for player for the first argument after ggplot( and also after the x = 
  geom_line() +
  geom_point() +
  geom_line(aes(y = DW$RegSeasonRPG),color = "blue")+
  geom_smooth(method = "lm", se = FALSE, color = "red")+
  labs(title = "Rebounds for Derrick White", #Here you would insert the players name as well after "for" and the respective stat line you modeled
       x = "Game",
       y = "Rebounds")
```
